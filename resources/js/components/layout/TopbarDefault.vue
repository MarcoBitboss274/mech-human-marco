<template>
    <header class="layout-topbar">
        ...
        <div class="flex flex-grow items-center justify-end">
            <BbPopover v-if="hasChatReadPermission">
...
const hasChatReadPermission = computed(() => can('chat.read'));
...
] satisfies BbDropdownItem[]);

onMounted(() => {
    if (hasChatReadPermission.value && user.value?.id) {
