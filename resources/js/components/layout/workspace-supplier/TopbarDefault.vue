<template>
    <header class="layout-topbar">
        ...
        <BbDropdown :items="userDropdownItems" :offset="15" theme="user-dropdown" :width="160">
...
const { currentUser: user, impersonating } = usePermissions();
...
const goToOperationChat = (operationId: number) => {
    router.get(
        route('workspace.supplier.operations.show', {
