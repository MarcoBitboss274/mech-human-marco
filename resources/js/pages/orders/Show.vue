<template>
    <div class="admin-view">
        <div class="admin-view__header">
            <h1 class="page__title">{{ t('Dettaglio ordine') }}</h1>
            <BbButton icon="arrow-left" @click="router.get(route('orders.index'))">{{ t('Torna alla lista') }}</BbButton>
        </div>
...
defineOptions({
    layout: (h: any, page: any) => h(AppLayout, { title: 'Dettaglio ordine' }, () => [page]),
});
