...
defineOptions({
    layout: (h: any, page: any) => h(WorkspaceSupplierLayout, { title: 'Profilo' }, () => [page]),
});
...
const save = () => {
    form.transform((data) => {
        ...
        return data;
    }).post(route('workspace.supplier.profile.update'), {
        preserveScroll: true,
        onSuccess: () => {
            toast({
                theme: 'success',
