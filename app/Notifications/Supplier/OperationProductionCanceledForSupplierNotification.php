...
class OperationProductionCanceledForSupplierNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ...
            ->subject('Produzione annullata')
            ->greeting('Ciao,')
            ->line('Mech & Human ha annullato l’avvio produzione per la lavorazione ' . ($this->operation->batch_number ?? '—') . '.')
    ...
    {
        return [
            'type' => 'supplier.operation.production_canceled',
