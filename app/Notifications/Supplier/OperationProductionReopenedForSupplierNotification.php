...
class OperationProductionReopenedForSupplierNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ...
            ->subject('Produzione riaperta')
            ->greeting('Ciao,')
            ->line('Mech & Human ha riaperto la produzione per la lavorazione ' . ($this->operation->batch_number ?? '—') . '.')
    ...
    {
        return [
            'type' => 'supplier.operation.production_reopened',
