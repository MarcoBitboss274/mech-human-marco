...
class ClosedPrescriptionRevisionForUser extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ...
            ->subject('Mech & Human - Revisione chiusa per la prescrizione ' . ($this->prescription->typology ?? '-'))
            ->markdown('mail.user.closed-prescription-revision-for-user', [
